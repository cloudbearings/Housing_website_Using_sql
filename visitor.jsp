<%-- 
    Document   : visitor
    Created on : 26 Apr, 2015, 12:51:41 AM
    Author     : ravi
--%>
...
cities['Karnataka']['Mysore'] = new Array('Victoria','Vasanth nagar');
...
<form action="./visitormaster.jsp" name="vist">
          <br>  <h2 style="color:#A5066D">BUYER DETAILS</h2><br>
        <table border="1">
